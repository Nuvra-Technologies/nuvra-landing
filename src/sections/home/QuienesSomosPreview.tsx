...
export default function QuienesSomosPreview() {
  return (
    <section className="relative pt-32 pb-16 md:pb-52">
          ...
          <FadeIn delay={0.1}>
            <div className="relative md:absolute md:left-1/2 md:-translate-x-1/2 md:-bottom-32 mt-6 md:mt-0 w-full max-w-2xl rounded-2xl bg-white p-4 shadow-xl text-center">
              <p className="text-neutral-700 text-lg leading-relaxed">
                ...
                <strong> desarrollo web profesional </strong>para pymes
                argentinas.
              </p>
              <p className="mt-4 text-neutral-600 text-base">
                Entendemos el contexto local: optimizar recursos, ordenar
                procesos y crear herramientas que realmente acompañen el
                crecimiento del negocio. Diseñamos soluciones claras, escalables
                y pensadas para el largo plazo.
              </p>
